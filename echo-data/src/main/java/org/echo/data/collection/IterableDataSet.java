 ...
 * @since V1.0.0
 * @param <E> the type of elements held in this IterableDataSet
 **/
@AllArgsConstructor
public class IterableDataSet<E> implements DataSet<E>, Iterator<E> {

    private DataLoader<E> dataLoader;
